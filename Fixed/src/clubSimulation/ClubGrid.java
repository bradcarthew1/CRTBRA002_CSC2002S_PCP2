...
public class ClubGrid {
	...
	private GridBlock exit; //shared grid block exit object
	private final GridBlock entrance; //hard coded entrance, shared grid block entrance object
	private final static int minX = 5; //minimum x dimension
	private final static int minY = 5; //minimum y dimension
	
	private final PeopleCounter counter; //shared PeopleCounter object
	...
	public GridBlock enterClub(PeopleLocation myLocation) throws InterruptedException  {
		...
		synchronized (entrance) {
			//wait if entrance block is occupied or no. clubgoers equals the maximum
